...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <li><a className="btn btn-primary mx-4 my-1" href="https://docs.kieranmcdonnell.com">Documents</a></li>
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 ">
      ...
      <li><a className="btn btn-primary mx-4" href="https://docs.kieranmcdonnell.com">Documents</a></li>
