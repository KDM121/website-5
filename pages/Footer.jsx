...
const Footer = () => {
  return (
<footer className="footer footer-center p-10 bg-gradient-to-b from-base-100 to-accent border-t-4 border-primary text-base-content rounded">
  ...
  <nav>
    ...
    <a href="mailto:emails@mcdonnell.cc" className="btn-circle btn btn-ghost"> <Image src="/email.png" width={35} height={35}></Image> </a>
